...
import static com.windroid.emu.activities.MainActivity.fileManagerCwd;
...
import static com.windroid.emu.fragments.DeleteItemFragment.DELETE_GAME_ITEM;
import static com.windroid.emu.fragments.EditGamePreferencesFragment.FILE_MANAGER_START_PREFERENCES;
import static com.windroid.emu.fragments.FloatingFileManagerFragment.OPERATION_CREATE_LNK;
import static com.windroid.emu.fragments.RenameFragment.RENAME_FILE;
...
public class FileManagerFragment extends Fragment {
    ...
    public static String ACTION_REFRESH_FILES = "com.windroid.emu.ACTION_REFRESH_FILES";
    public static ArrayList<AdapterFiles.FileList> fileList = new ArrayList<>();

    public static void refreshFiles(Context context) {
        context.sendBroadcast(new Intent(ACTION_REFRESH_FILES).setPackage("com.windroid.emu"));
    }
