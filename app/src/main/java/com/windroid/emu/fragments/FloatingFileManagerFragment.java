...
import static com.windroid.emu.activities.MainActivity.ACTION_SETUP;
import static com.windroid.emu.activities.MainActivity.customRootFSPath;
import static com.windroid.emu.activities.MainActivity.fileManagerDefaultDir;
import static com.windroid.emu.activities.MainActivity.floatingFileManagerCwd;
import static com.windroid.emu.activities.MainActivity.selectedFilePath;
...
import static com.windroid.emu.adapters.AdapterPreset.clickedPresetType;
import static com.windroid.emu.fragments.Box64PresetManagerFragment.exportBox64Preset;
import static com.windroid.emu.fragments.Box64PresetManagerFragment.importBox64Preset;
import static com.windroid.emu.fragments.ControllerPresetManagerFragment.exportControllerPreset;
import static com.windroid.emu.fragments.ControllerPresetManagerFragment.importControllerPreset;
...
import static com.windroid.emu.fragments.ShortcutsFragment.putExePath;
import static com.windroid.emu.fragments.ShortcutsFragment.setIconToGame;
import static com.windroid.emu.fragments.VirtualControllerPresetManagerFragment.exportVirtualControllerPreset;
import static com.windroid.emu.fragments.VirtualControllerPresetManagerFragment.importVirtualControllerPreset;
import static com.windroid.emu.utils.DriveUtils.parseWindowsPath;
...
import com.windroid.emu.adapters.AdapterFiles;
...
public class FloatingFileManagerFragment extends DialogFragment {
        ...
        switch (operationType) {
            ...
            case OPERATION_SELECT_FOLDER -> {
                ...
                saveButton.setOnClickListener((v) -> {
                    ...
                    new Thread(() -> {
                        com.windroid.emu.activities.GeneralSettingsActivity.scanGames(outputFile, requireContext());
                        outputFile = null;
                        dismiss();
                    }).start();
                });
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        if (!calledSetup && operationType == OPERATION_SELECT_RAT) {
            calledSetup = true;
            requireContext().sendBroadcast(new Intent(ACTION_SETUP).setPackage("com.windroid.emu"));
        }
    }
