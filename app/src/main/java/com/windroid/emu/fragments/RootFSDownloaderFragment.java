...
import static com.windroid.emu.adapters.AdapterRatPackage.ROOTFS;
import static com.windroid.emu.core.RootFSDownloaderService.DOWNLOAD_DONE;
import static com.windroid.emu.core.RootFSDownloaderService.DOWNLOAD_FAILED;
import static com.windroid.emu.core.RootFSDownloaderService.DOWNLOAD_START;
import static com.windroid.emu.core.RootFSDownloaderService.UPDATE_PROGRESS_BAR;
...
import com.windroid.emu.adapters.AdapterRatPackage;
...
public class RootFSDownloaderFragment extends Fragment {
    ...
    private List<RootFSPackage> fetchRootFS() {
        ...
        Request requestAll = new Request.Builder().url("https://api.github.com/repos/WINDROID-EMU/Windroid-Rootfs/releases").build();
        Request requestLatest = new Request.Builder().url("https://api.github.com/repos/WINDROID-EMU/Windroid-Rootfs/releases/latest").build();
