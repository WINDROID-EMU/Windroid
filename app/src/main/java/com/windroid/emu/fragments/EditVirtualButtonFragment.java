...
import static com.windroid.emu.activities.VirtualControllerOverlayMapper.ACTION_INVALIDATE;
import static com.windroid.emu.controller.XKeyCodes.getKeyNames;
import static com.windroid.emu.controller.XKeyCodes.getMapping;
import static com.windroid.emu.views.VirtualKeyboardInputCreatorView.ANALOG;
import static com.windroid.emu.views.VirtualKeyboardInputCreatorView.BUTTON;
import static com.windroid.emu.views.VirtualKeyboardInputCreatorView.DPAD;
import static com.windroid.emu.views.VirtualKeyboardInputCreatorView.lastSelectedButton;
import static com.windroid.emu.views.VirtualKeyboardInputCreatorView.lastSelectedType;
...
public class EditVirtualButtonFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener((v) -> {
            ...
            requireContext().sendBroadcast(new Intent(ACTION_INVALIDATE).setPackage("com.windroid.emu"));
            dismiss();
        });
