...
import static com.windroid.emu.activities.MainActivity.ACTION_INSTALL_ADTOOLS_DRIVER;
import static com.windroid.emu.activities.MainActivity.ACTION_INSTALL_RAT;
...
import com.windroid.emu.core.RatPackageManager.AdrenoToolsPackage;
...
public class AskInstallPackageFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        buttonContinue.setOnClickListener((v) -> {
            switch (packageType) {
                case RAT_PACKAGE -> requireContext().sendBroadcast(new Intent(ACTION_INSTALL_RAT).setPackage("com.windroid.emu"));
                case ADTOOLS_DRIVER_PACKAGE -> requireContext().sendBroadcast(new Intent(ACTION_INSTALL_ADTOOLS_DRIVER).setPackage("com.windroid.emu"));
                case MWP_PRESET_PACKAGE -> {
